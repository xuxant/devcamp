...
const BootcampSchema = new mongoose.Schema(
  {
    ...
    description: {
      ...
      trim: true,
      maxlength: [500, 'Name cannot be more then 50 Character!']
    },
    website: {
      type: String,
      match: [
    ...
    phone: {
      type: String,
      maxlength: [20, 'Phoen number cannot be longer then 20 characters.']
    },
    email: {
      type: String,
      match: [
    ...
    averageRating: {
      ...
      max: [10, 'Rating cannot be higher then Ten.']
    },
    averageCost: {
      type: Number
    },
